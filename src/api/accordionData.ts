export const accordionData = [
  ...
  {
    title: 'Requirements',
    content: `The application needs to meet several requirements! The topic is chosen by each student
    individually. Each week, students need to prove to have understood, learned and implemented new topics.
  ...
  {
    title: 'Checkpoints',
    content: `The weekly checkpoints help the students build the application on a consistent basis. The following
